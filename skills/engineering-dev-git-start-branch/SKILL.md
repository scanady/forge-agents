...
metadata:
  ...
  priority: specific
  related-skills: engineering-dev-git-commit, engineering-dev-git-finish-branch, engineering-dev-git-workflow-design
---
...
**Announce at start:** "I'm using the engineering-dev-git-start-branch skill to set up your branch."
...
Next:
- Make changes, then commit: /engineering-dev-git-commit
- When work is complete:   /engineering-dev-git-finish-branch
```
