...
metadata:
  ...
  priority: specific
  related-skills: strategy-planning-opportunity, research-market-researcher, research-market-analyst, research-weekly-ai-news, product-strategy-validator
---
...
Use this skill to create opportunities. Use `strategy-planning-opportunity` to assess one opportunity and decide whether to grow, launch, pivot, run, kill, or remove it. Use `research-market-researcher` when a generated idea needs deeper market sizing or competitor diligence.
