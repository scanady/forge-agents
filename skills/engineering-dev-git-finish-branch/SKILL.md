...
metadata:
  ...
  related-skills: engineering-dev-git-start-branch, engineering-dev-git-commit, engineering-dev-git-workflow-design
---
...
**Announce at start:** "I'm using the engineering-dev-git-finish-branch skill to complete this work."
